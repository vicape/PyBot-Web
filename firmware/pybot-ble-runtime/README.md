...
**Versión:** runtime **3.2.6**, protocolo **3.1** (comandos iguales; no rompe clientes 3.1).
...
(evita `machine.reset()` que tumba el GATT en el 2º Run tras Stop).
...
4. Abrir el panel Bluetooth: debe aparecer `PYBOT-XXXXXX` y `INFO.firmware == 3.2.6`.
