...
Creado por VIC.`,
    ...
    prepareEsp32Btn: "Preparar ESP32 para PyBot",
    prepareEsp32MenuHint:
      "Instala MicroPython oficial y el runtime PyBot completo en una ESP32, desde Chrome o Edge por USB. No copia el programa del editor.",
    prepareEsp32Title: "Preparar ESP32 para PyBot",
    prepareEsp32Intro:
    ...
    prepareEsp32ConfirmReinstall:
      "Vamos a reinstalar el runtime PyBot completo (BLE nativo, EDA6, red). Si MicroPython ya es compatible, no se vuelve a grabar el firmware. No se copia el programa del editor.",
    prepareEsp32ConfirmYes: "Continuar",
    prepareEsp32ConfirmNo: "Cancelar",
    prepareEsp32Cancel: "Cerrar",
    prepareEsp32Retry: "Reintentar",
    prepareEsp32RetryFull: "Reintentar instalación completa",
    prepareEsp32Incomplete: "Preparación incompleta. La ESP32 no quedó lista para PyBot.",
    prepareEsp32Reinstall: "Reinstalar PyBot en ESP32",
    prepareEsp32Ready: "ESP32 lista para PyBot. Ya podés usarla por USB o conectar Bluetooth.",
    prepareEsp32Already:
    ...
    prepareState_INCOMPLETE: "Instalación PyBot incompleta",
    prepareState_OLD_PYBOT: "PyBot desactualizado",
    prepareState_READY: "PyBot al día",
    prepareState_INCOMPATIBLE_MPY: "MicroPython incompatible",
    ...
    preparePhase_ERROR: "Preparación incompleta. Podés reintentar la instalación completa.",
    ...
    mpyStateOldPybot:
      "PyBot necesita actualizar la ESP32. Usá «Preparar ESP32 para PyBot» o «Reinstalar PyBot».",
    mpyStateIncomplete:
      "PyBot necesita actualizar la ESP32: faltan archivos del runtime. Usá «Reinstalar PyBot».",
    mpyStateReady: "ESP32 lista para PyBot. Ya podés trabajar por USB o Bluetooth.",
  ...
  en: {
    ...
    accountPanelMenu: "Open dashboard",
    menuActions: "Actions",
...
Built by VIC.`,
    ...
    prepareEsp32Btn: "Prepare ESP32 for PyBot",
    prepareEsp32MenuHint:
      "Installs official MicroPython and the full PyBot runtime on an ESP32 from Chrome or Edge over USB. Does not copy the editor program.",
    prepareEsp32Title: "Prepare ESP32 for PyBot",
    prepareEsp32Intro:
    ...
    prepareEsp32ConfirmReinstall:
      "This reinstalls the full PyBot runtime (native BLE, EDA6, network). If MicroPython is already compatible, firmware is not reflashed. The editor program is not copied.",
    prepareEsp32ConfirmYes: "Continue",
    prepareEsp32ConfirmNo: "Cancel",
    prepareEsp32Cancel: "Close",
    prepareEsp32Retry: "Retry",
    prepareEsp32RetryFull: "Retry full installation",
    prepareEsp32Incomplete: "Incomplete preparation. The ESP32 is not ready for PyBot.",
    prepareEsp32Reinstall: "Reinstall PyBot on ESP32",
    prepareEsp32Ready: "ESP32 ready for PyBot. You can use it over USB or connect Bluetooth.",
    prepareEsp32Already:
    ...
    prepareState_INCOMPLETE: "Incomplete PyBot install",
    prepareState_OLD_PYBOT: "Outdated PyBot",
    prepareState_READY: "PyBot up to date",
    prepareState_INCOMPATIBLE_MPY: "Incompatible MicroPython",
    ...
    preparePhase_ERROR: "Incomplete preparation. You can retry the full installation.",
    ...
    mpyStateOldPybot:
      "PyBot needs to update the ESP32. Use «Prepare ESP32 for PyBot» or «Reinstall PyBot».",
    mpyStateIncomplete:
      "PyBot needs to update the ESP32: runtime files are missing. Use «Reinstall PyBot».",
    mpyStateReady: "ESP32 ready for PyBot. You can work over USB or Bluetooth.",
