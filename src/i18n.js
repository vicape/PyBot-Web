const STRINGS = {
  es: {
    ...
    pyblockMsgForever: "por siempre %1 %2",
    pyblockTipForever: "Repite los bloques de adentro para siempre (while True).",
...
Creado por VIC.`,
  ...
  en: {
    ...
    pyblockMsgForever: "forever %1 %2",
    pyblockTipForever: "Repeats the blocks inside forever (while True).",
